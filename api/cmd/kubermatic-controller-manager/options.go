...
func newControllerRunOptions() (controllerRunOptions, error) {
	...
	flag.StringVar(&c.kubernetesAddonsList, "kubernetes-addons-list", "canal,dashboard,dns,kube-proxy,openvpn,rbac,kubelet-configmap,default-storage-class,node-exporter,nodelocal-dns-cache,logrotate", "Comma separated list of Addons to install into every user-cluster")
	...
	flag.StringVar(&c.monitoringEnvironmentLabel, "monitoring-environment-label", "", "The label for monitoring environment label. Default: ''")
